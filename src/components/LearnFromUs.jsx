...
const LearnFromUs = () => {
    return (
        <div className='pt-5 position-relative'>
            <Container>
                <h2 className='mb-0 ff-sohne fw-bold fs-2xl text-black text-uppercase text-center'>Learn from us.</h2>
                <p className='mb-0 ff-maisonnormal fw-normal fs-4sm text-black text-center'>Digital marketing resources from Venveo to help you grow.</p>
                ...
                <div className='position-relative'>
                    ...
                    <div className='position-absolute start-0 end-0 bottom-0 p-4'>
