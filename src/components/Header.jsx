        ...
        <div className='bg_header position-relative mb-5'>
            <Container fluid className='p-0 d-flex justify-content-end'>
                <ul className={`${show ? "left_100" : "left_0"} nav_bar`}>
                    ...
                    <li onClick={() => setshow(!show)} className='cur_pointer position-relative'>
                    ...
                    <li onClick={() => setshow(!show)} className='ff-maisonmedium fw-medium fs-4sm text-black lh-106 ps-lg-4 pe-lg-4 text-nowrap cur_pointer py-lg-0 py-3'>Resources</li>
                </ul>
                ...
                <div className={`${show ? "pe-lg-3 tr-linear ps-lg-1 ps-4 pe-4 pt-3 pb-4 bg-white d-flex align-items-center justify-content-center" : "pe-lg-3 tr-linear ps-lg-1 ps-4 pe-4 pt-3 pb-4 bg-white d_flex align-items-center justify-content-center d_none"}`}>
                    <Searchicon />
                </div>
                <div className={`${show ? 'ff-maisonsemibold tr-linear d-flex align-items-center fw-semibold fs-4sm text-black py-3 bg_greenD2 px-4 text-nowrap' : "ff-maisonsemibold tr-linear d_flex align-items-center fw-semibold fs-4sm text-black py-3 bg_greenD2 px-4 text-nowrap d_none"}`}>Let’s Talk<Navarrow /></div>
            </Container>
            <Container className='d-flex align-items-center flex-column justify-content-center'>
                <div className='d-flex align-items-center justify-content-center pt-5 mt-5 position-relative'>
                    <h1 className='mb-0 ff-sohne fw-bold fs-3xl mw-822 lh-86 text-white text-uppercase text-center'>Make marketing
                ...
                <div className='d-flex align-items-center justify-content-center pt-4 gap-4 flex-column'>
                ...
                <div className='d-flex align-items-center justify-content-center pt-4 mw-871 position-relative z-2'>
